...
* For Simulink functions, it is important to check box that says something similar to 'Refresh Simulink customizations after openning or closing this project'.
